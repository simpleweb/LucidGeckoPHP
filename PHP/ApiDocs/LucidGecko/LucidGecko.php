...
class LucidGecko {
	...
	//const API_SERVER = "http://swm2.dyndns.org/api/";
	 ...
	 */
	public static function getInstance($appKey = null, $appSecret = null) {
		
		if(self::$_instance === null) self::$_instance = new self($appKey, $appSecret);
	...
	private function postRequest($method, $params = null) {
		...
		if (function_exists('curl_init')) {
			...
			curl_setopt($ch, CURLOPT_POSTFIELDS, $parmsQs);
		...
		$result = $this->getRequestResult($method, simplexml_load_string($rawResult));
